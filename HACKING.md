...
hidden if the `cardcrank-cpp_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `cardcrank-cpp_DEVELOPER_MODE` to the configure
...
Runs the executable target `cardcrank-cpp_exe`.
